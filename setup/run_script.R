...
NafSetup('FullAbund')
NafCond(dir='FullAbund',search.string = 'NF-B[1|2|3|5|6]-..dat')
NafResults('FullAbund',db_name='FullAbund.db')
NafVariants(dir='FullAbund',var.search = 'Naf-v[0-2].par',search.string = 'NF-B[1|2|3|5|6]-..dat')
file.copy('settings/clc-n-rev.par',to = 'FullAbund/clc-n.par',overwrite = TRUE)
NafVariants(dir='FullAbund',var.search = 'Naf-v[3-7].par',search.string = 'NF-B[1|2|3|5|6]-..dat')
